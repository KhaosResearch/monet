...
***************************************
 Files containing parameters for the models used to generate the data (S-System) contain the word 'params' in the file name. E.g.  SS20Params.txt contains S-System parameters for a 20 gene network.
...
E.g. SS20GeneratedData.txt contains time series generated by the S-System model for a 20 gene network. For the noise added data, the file names are added a suffix: e.g. SS5GeneratedData1Noise.txt contains simulated data for a 5 gene S-System with 1% added noise.

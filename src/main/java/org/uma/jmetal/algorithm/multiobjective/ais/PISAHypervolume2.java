...
public class PISAHypervolume2<S extends Solution<?>> extends Hypervolume<S> {
     ...
     */
    public PISAHypervolume2(String referenceParetoFrontFile) throws FileNotFoundException {
     ...
     * @throws FileNotFoundException
     */
    public PISAHypervolume2(Front referenceParetoFront) {
    ...
    public List<S> computeHypervolumeContribution(List<S> solutionList, List<S> referenceFrontList) {
        if (solutionList.size() > 1) {
            ...
            for (int i = 0; i < contributions.length; i++) {
                System.out.println("The contribution is : "+contributions[i]);

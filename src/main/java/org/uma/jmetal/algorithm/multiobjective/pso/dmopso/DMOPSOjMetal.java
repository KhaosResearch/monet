...
public class DMOPSOjMetal implements Algorithm<List<DoubleSolution>> {
  /**
	 * Version of DMOPSO included in jMetal 5.2
	 */
  ...
  public DMOPSOjMetal(DoubleProblem problem, int swarmSize,

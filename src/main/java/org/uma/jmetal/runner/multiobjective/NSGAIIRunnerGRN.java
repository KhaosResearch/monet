 ...
 */
public class NSGAIIRunnerGRN extends AbstractAlgorithmRunner {
  /**
   ...
   */
  public static void main(String[] args) throws JMetalException, FileNotFoundException, ClassNotFoundException {
    ...
    if (args.length == 1) {
      ...
      problemName = "/datasets-gnw/comparative/Tominaga5SSGeneratedData.txt";

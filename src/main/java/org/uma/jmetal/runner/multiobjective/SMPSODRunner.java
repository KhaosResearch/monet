...
import org.uma.jmetal.algorithm.multiobjective.pso.smpsod.SMPSODBuilder;
...
public class SMPSODRunner {
   ...
   * Invoking command:
  java SMPSOHvRunner problemName [referenceFront]
   */
  public static void main(String[] args) throws Exception {
    ...
    algorithm = new SMPSODBuilder(problem)
